...
metaData.data_1     = {'t-Wwe'; 't-Wwe'; 't-Le'; 't-L'; 't-Ww'; 'L-Ww'; 't-JX'; 'Ww-N'}; 
...
% use for validation
weights.tWw_C46 = 0 *weights.tWw_C46;weights.tWw_C47= 0 *weights.tWw_C47; weights.tWw_C50 = 0 *weights.tWw_C50;
...
%% Group plots
set1 = {'tLe1','tLe2'}; comment1 = {'Data of Angu1932 (Albino rat) and NaraFox1971 (Wistar)'};
set2 = {'tWw_m2598','tWw_m0392'};  comment2 = {'Wet weight, males 2598 and 0392'};
set3 = {'tJX_m2598','tJX_m0392'}; comment3 = {'Ingestion rate, males 2598 and 0392'};
set4 = {'tWw_f_np2598','tWw_f1_np2598','tWw_f0_2598','tWw_f0_0392'}; comment4 = {'Wet weight, non-pregnant females F0 & F1 of 2598 + females F0 2598 and 0392'};
set5 = {'tJX_f_np2598','tJX_f1_np2598','tJX_f0_2598','tJX_f0_0392'}; comment5 = {'Ingestion rate, non-pregnant females F0 & F1 of 2598 + females F0 2598 and 0392'};
set6 = {'tWw_F0p_2598','tWw_F0p_0392'}; comment6 = {'pups, from females F0 2598 and 0392'};
set7 = {'tWw_C41','tWw_C44', 'tWw_C49'}; comment7 = {'OECD control data females (pink C44, red C41, blue C49)'};
set8 = {'tWw_05study_f','tWw_05study_m'}; comment8 = {'male (blue) and female (red) in control trial'};
set9 = {'WwN_2598','WwN_0392'}; comment9 = {'studies 2598 (red) and 0392 (blue), 2 generations'};
set10 = {'tWw_C46','tWw_C47', 'tWw_C50'}; comment10 = {'OECD control data females (C46, C47, C50)'};
...
%% Discussion points
D1 = ['Contrary to the version 2018/06/18  >> Additional t-Ww, and t-JX (ingestion rate) and Ww-N  data added. For simplicity, only mean data (of each study) uploaded for t-Ww and t-JX, '...
...
D2 = ['Parameters: [E_G] now higher but more in line with other rat entries. [p_M] higher (compared to prev.version and other rat entries), but possibly due to the fact '...
...
D3 = ['New function dget_EVH_AF developed with Dina Lika to calculate size and age at birth and weaning, and body mass and upregulation (of feeding) of mother '...
...
D4 = ['All (adult) females are modelled with the new function, with non-pregnant females having the litter size of zero, ' ... 
    'and pregnant females the average litter size in that study.'];
D5 = ['Currently the (measurable) growth of embryo starts after t_0, but this period between fertilization  and growth is possibly used to prepare other'...
...
D6 = 'Kept from version 2018/06/18: All data present + specific function get_eL2 used for control males';

metaData.discussion = struct('D1', D1, 'D2', D2, 'D3', D3, 'D4', D4, 'D5', D5, 'D6', D6);

%% Acknowledgment
metaData.acknowledgment = 'This entry (version 2019/12/12) was financially supported by Bayer.';

%% Links
metaData.links.id_CoL = '58d474ec035208b2194df25dde8f9259'; % Cat of Life
metaData.links.id_EoL = '328448'; % Ency of Life
metaData.links.id_Wiki = 'Rattus_norvegicus_Wistar'; % Wikipedia
metaData.links.id_ADW = 'Rattus_norvegicus_Wistar'; % ADW
metaData.links.id_Taxo = '63135'; % Taxonomicon
metaData.links.id_MSW3 = '13001766'; % Mammal Spec World
metaData.links.id_AnAge = 'Rattus_norvegicus_Wistar'; % AnAge
