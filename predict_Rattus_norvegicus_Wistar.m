...
% time-weight control data FEMALES
  ...
  EVH_AF_0 = [f_C * E_m * V_start, V_start, 0, 0, 1e-8, 0]; % initial conditions [E, V, E_R, E_F, V_F, EH_F], assume res reserve density of e=f, and repro buffer empty 
...
% time-weight control data 
 ...
 % time-weight control data FEMALE NO 44
  ...
  EVH_AF_0 = [f_C46 * E_m * V_start, V_start, 0, 0, 1e-8, 0]; % initial conditions [E, V, E_R, E_F, V_F, EH_F], assume res reserve density of e=f, and repro buffer empty 
  options = odeset('Events', @event_bx);
 ...
 % time-weight control data FEMALE Baye2005 study  
  ...
  EVH_AF_0 = [f_C50 * E_m * V_start, V_start, 0, 0, 1e-8, 0]; % initial conditions [E, V, E_R, E_F, V_F, EH_F], assume res reserve density of e=f, and repro buffer empty 
  options = odeset('Events', @event_bx);
...
function [value,isterminal,direction] = event_bx(t, EVH_AF, pars_AF, upreg)
  % AF: 6-vector
